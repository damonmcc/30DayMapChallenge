...
file_path <- paste(script_dir, "/01 Points - ", borough_name, " Community Spaces - ", Sys.time(), ".png", sep="")
...
p1 <- ggplot() + 
  ...
  geom_point(data=pluto, aes(x=longitude, y=latitude, color=BuildingType), alpha=0.75, size=point_size) +
